...
setwd("C:/Users/mwestbrook/Desktop/Projects/Striped Bass")
...
shape<-st_read("C:/Users/mwestbrook/Desktop/Projects/Striped Bass")
...
```{r plot params, echo=FALSE}
 ...
 # crosssectionmain<-read.csv("C:/Users/AKeppel/Desktop/Helpful Info/mainchannelpointsCLEAN.csv")
  crosssectionmain<-read.csv("C:/Users/mwestbrook/Desktop/Projects/Striped Bass/mainchannelpointsCLEAN.csv")
...
maxvalue<-3
 ...
 backgroundforsurface<-read.csv("C:/Users/mwestbrook/Desktop/Projects/Striped Bass/allbaypoints.csv")
...
htmlwidgets::saveWidget(as_widget(surfacedataplotlyforexport), paste("C:/Users/mwestbrook/Desktop/Projects/Striped Bass/fishingareasurface",thiscruise,thisyear,Sys.Date(),".html"))
...
DOdata<-list.files(path="C:/Users/mwestbrook/Desktop/Projects/Striped Bass",pattern=DOidpattern)
DOdata<-DOdata[length(DOdata)]
# DOdata<-read.csv
DOdata<-read.csv(paste("C:/Users/mwestbrook/Desktop/Projects/Striped Bass",DOdata,sep=""))
...
Wtempdata<-list.files(path="C:/Users/mwestbrook/Desktop/Projects/Striped Bass",pattern=Wtempidpattern)
...
Wtempdata<-read.csv(paste("C:/Users/mwestbrook/Desktop/Projects/Striped Bass",Wtempdata,sep=""))
